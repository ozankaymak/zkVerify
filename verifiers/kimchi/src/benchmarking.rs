...
// Generated from a valid XOR-lookup recursive Kimchi circuit with domain size
// 65536, the runtime's current maximum public input count, and the maximum
// supported previous-challenge count. XOR exercises the protocol's maximum
// lookups-per-row and joint-lookup size.
